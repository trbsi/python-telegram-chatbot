...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'chatapp.context_processor.global_vars'
            ],
        },
    },
]
...
# AI
IS_LOCAL_AI_ENABLED = env.bool('IS_LOCAL_AI_ENABLED')
HUGGING_FACE_TOKEN = env('HUGGING_FACE_TOKEN')

# GPU
GPU_PROVIDER = env('GPU_PROVIDER')
GPU_DISK_GB = env('GPU_DISK_GB')
VAST_API_KEY = env('VAST_API_KEY')
VAST_TEMPLATE_HASH = env('VAST_TEMPLATE_HASH')
...
MODEL_ZIP_URL = env('MODEL_ZIP_URL')
